...
- Added missing `scikit-learn` production dependency required by the SVR-based event detection service.

[0.2.1]: https://github.com/ppadillaq/wavelet-lab/releases/tag/v0.2.1
